...
const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/adaptar`, {
...
Role.belongsToMany(User, {troungh: 'UserRole'});
User.hasMany(Recipe, {troungh: 'UserReceipe'}); */
